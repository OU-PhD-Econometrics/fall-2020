...
\item Estimate the same regression model as above, but now add the six \texttt{asvab} variables contained in the CSV file.
...
\item Repeat question 3, but use \texttt{FactorAnalysis} instead of \texttt{PCA} (the syntax should be exactly the same)
